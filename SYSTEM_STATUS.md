...
> ⚠️ 本项目有两种 Agent，职责不同：
> - **远程 Agent**（assign_copilot_to_issue）：实现代码、创建 PR
> - **本地 Agent**（GitHub Copilot in VS Code）：分析规划、审查、解决冲突、合并
